...
const accessNeeds = [
  { id: 'walking', icon: '🚶', label: 'Minimize walking' },
  { id: 'stairs', icon: '🛗', label: 'Avoid stairs' },
  { id: 'standing', icon: '🧍', label: 'Minimize standing' },
  { id: 'seating', icon: '🪑', label: 'Frequent seating' },
  { id: 'heat', icon: '🌡️', label: 'Avoid heat' },
  { id: 'indoors', icon: '🏢', label: 'Prefer indoors' },
  { id: 'quiet', icon: '🔇', label: 'Quiet environment' },
  { id: 'crowds', icon: '👥', label: 'Avoid crowds' },
  { id: 'restroom', icon: '🚻', label: 'Restrooms nearby' },
  { id: 'water', icon: '💧', label: 'Water nearby' },
  { id: 'elevator', icon: '↕️', label: 'Elevator required' },
  { id: 'simple', icon: '✨', label: 'Simpler instructions' },
];
